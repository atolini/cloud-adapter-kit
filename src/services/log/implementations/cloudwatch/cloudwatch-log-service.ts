...
export class CloudWatchLogService<T> implements ILogService<T, LogContainer> {
   ...
   *
   * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cloudwatch-logs/command/PutLogEventsCommand/ | DataAlreadyAcceptedException} If the logs are already accepted.
   * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cloudwatch-logs/command/PutLogEventsCommand/ | InvalidParameterException} If the parameters are invalid.
   * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cloudwatch-logs/command/PutLogEventsCommand/ | InvalidSequenceTokenException} If the sequence token is invalid.
   * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cloudwatch-logs/command/PutLogEventsCommand/ | ResourceNotFoundException} If the specified log group or log stream does not exist.
   * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cloudwatch-logs/command/PutLogEventsCommand/ | ServiceUnavailableException} If the service is unavailable.
   * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cloudwatch-logs/command/PutLogEventsCommand/ | UnrecognizedClientException} If the client is unrecognized.
   *
