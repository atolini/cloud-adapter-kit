...
export class SESEmailService implements IEmailService {
   ...
   *   .catch((error) => console.error('Error sending email:', error));
   *
   * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/ses/command/SendEmailCommand/ | AccountSendingPausedException} If the Amazon SES account is paused from sending emails.
   * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/ses/command/SendEmailCommand/ | ConfigurationSetDoesNotExistException} If the specified configuration set does not exist.
   * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/ses/command/SendEmailCommand/ | ConfigurationSetSendingPausedException} If the specified configuration set is paused from sending emails.
   * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/ses/command/SendEmailCommand/ | MailFromDomainNotVerifiedException} If the sender's email address is not verified with Amazon SES.
   * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/ses/command/SendEmailCommand/ | MessageRejected} If the email message is rejected by Amazon SES.
   *
