...
import { IUserDirectoryService, CreateUserInput, UpdateUserAttributesInput, DeleteUserInput, IUserDirectoryServiceEventLogger } from '@user-directory/contracts';
/**
 *
...
export declare class CognitoUserDirectoryService implements IUserDirectoryService<AttributeType> {
     ...
     *
     * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cognito-identity-provider/command/AdminCreateUserCommand/ | InternalErrorException} If there is an internal error in the AWS Cognito service.
     * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cognito-identity-provider/command/AdminCreateUserCommand/ | InvalidParameterException} If the provided parameters are invalid.
     * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cognito-identity-provider/command/AdminCreateUserCommand/ | InvalidPasswordException} If the provided password does not meet the policy requirements.
     * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cognito-identity-provider/command/AdminCreateUserCommand/ | NotAuthorizedException} If the caller is not authorized to perform the operation.
     * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cognito-identity-provider/command/AdminCreateUserCommand/ | UsernameExistsException} If the username already exists in the User Pool.
     * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cognito-identity-provider/command/AdminCreateUserCommand/ | TooManyRequestsException} If the request is throttled due to too many requests.
     *
     ...
     *
     * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cognito-identity-provider/command/AdminUpdateUserAttributesCommand/ | InvalidEmailRoleAccessPolicyException} If Cognito isn't allowed to use your email identity.
     * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cognito-identity-provider/command/AdminUpdateUserAttributesCommand/ | InternalErrorException} If there is an internal error in the AWS Cognito service.
     * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cognito-identity-provider/command/AdminUpdateUserAttributesCommand/ | InvalidParameterException} If the provided parameters are invalid.
     * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cognito-identity-provider/command/AdminUpdateUserAttributesCommand/ | NotAuthorizedException} If the caller is not authorized to perform the operation.
     * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cognito-identity-provider/command/AdminUpdateUserAttributesCommand/ | UserNotFoundException} If the specified user does not exist in the User Pool.
     *
     * This function uses the AWS SDK command:
     ...
     *
     * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cognito-identity-provider/command/AdminDeleteUserCommand/ | InternalErrorException} If there is an internal error in the AWS Cognito service.
     * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cognito-identity-provider/command/AdminDeleteUserCommand/ | InvalidParameterException} If the provided parameters are invalid.
     * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cognito-identity-provider/command/AdminDeleteUserCommand/ | NotAuthorizedException} If the caller is not authorized to perform the operation.
     * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cognito-identity-provider/command/AdminDeleteUserCommand/ | UserNotFoundException} If the specified user does not exist in the User Pool.
     * @throws {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/cognito-identity-provider/command/AdminDeleteUserCommand/ | TooManyRequestsException} If the request is throttled due to too many requests.
     *
     * This function uses the AWS SDK command:
